    ...
    <section className="relative pt-32 pb-20 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center relative z-10">
        <div className="max-w-2xl">
          ...
          >
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#12151C] border border-[#232734] text-xs font-medium text-[#98A2B3] mb-8">
            ...
            <p className="text-lg text-[#98A2B3] mb-10 max-w-lg leading-relaxed">
              Keyboard-first note taking with blocks, Markdown support, file uploads, and direct sync to GitHub, Google Drive, and Notion.
            </p>
            
            <div className="flex flex-col sm:flex-row items-center gap-4 mb-12">
              <Link href="/register" className="w-full sm:w-auto flex items-center justify-center gap-2 bg-[#7C5CFF] hover:bg-[#684CE6] text-white px-6 py-3.5 rounded-xl font-medium transition-all shadow-[0_0_20px_rgba(124,92,255,0.3)] hover:shadow-[0_0_30px_rgba(124,92,255,0.5)]">
    ...
    <section className="py-32 bg-[#12151C] border-t border-[#232734] relative overflow-hidden text-center">
      ...
      <div className="max-w-3xl mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <Link href="/register" className="w-full sm:w-auto px-8 py-4 rounded-xl bg-[#7C5CFF] hover:bg-[#684CE6] text-white font-medium text-lg transition-colors shadow-xl shadow-[#7C5CFF]/30">
